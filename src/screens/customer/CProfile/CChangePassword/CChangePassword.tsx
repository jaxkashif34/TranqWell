...
import type { AuthCustomerScreenProps, FieldsForForm } from '~types';
import { Password } from '~components';
import { SText, SView, SButton } from '~base';
import { useFormik } from 'formik';
import { changePasswordValidation, initialValues } from '~helpers';
import { fields } from '~constants';
import { useAppDispatch } from '~hooks';
import { Ionicons } from '@expo/vector-icons';
import { SafeAreaView } from 'react-native-safe-area-context';

export const CChangePassword: FC<
  AuthCustomerScreenProps<'CChangePassword'>
> = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <SView className="mt-8 p-4 flex-1 pb-10">
        <Password
